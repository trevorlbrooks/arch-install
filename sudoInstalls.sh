...
pip install i3ipc
pacman -S powerline powerline-fonts dunst openssh --noconfirm --needed
...
su tbrooks -c sh -c "$(curl -fsSL https://raw.githubusercontent.com/trevorlbrooks/arch-install/vmInstall/userInstalls.sh)"
